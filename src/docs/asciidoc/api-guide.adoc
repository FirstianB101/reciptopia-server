...
* AccountProfileImg Search API 수정
...
operation::accountProfileImg-retrieve-example[snippets='response-fields,curl-request']
...
=== AccountProfileImg 검색

`GET /account/profileImgs?ownerId=` 요청으로 Account의 id로 AccountProfileImg를 조회(리소스 다운로드)합니다.

operation::accountProfileImg-search-example[snippets='request-parameters,curl-request']
